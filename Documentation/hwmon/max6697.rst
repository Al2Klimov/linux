...
Supported chips:
  ...
  * Maxim MAX6581
    ...
    Datasheet: https://datasheets.maximintegrated.com/en/ds/MAX6581.pdf

  * Maxim MAX6602

    Prefix: 'max6602'

    Datasheet: https://datasheets.maximintegrated.com/en/ds/MAX6602.pdf

  * Maxim MAX6622

    Prefix: 'max6622'

    Datasheet: https://datasheets.maximintegrated.com/en/ds/MAX6622.pdf

  * Maxim MAX6636

    Prefix: 'max6636'

    Datasheet: https://datasheets.maximintegrated.com/en/ds/MAX6636.pdf

  * Maxim MAX6689

    Prefix: 'max6689'

    Datasheet: https://datasheets.maximintegrated.com/en/ds/MAX6689.pdf

  * Maxim MAX6693

    Prefix: 'max6693'

    Datasheet: https://datasheets.maximintegrated.com/en/ds/MAX6693.pdf

  * Maxim MAX6694

    Prefix: 'max6694'

    Datasheet: https://datasheets.maximintegrated.com/en/ds/MAX6694.pdf

  * Maxim MAX6697

    Prefix: 'max6697'

    Datasheet: https://datasheets.maximintegrated.com/en/ds/MAX6697.pdf

  * Maxim MAX6698

    Prefix: 'max6698'

    Datasheet: https://datasheets.maximintegrated.com/en/ds/MAX6698.pdf

  * Maxim MAX6699

    Prefix: 'max6699'

    Datasheet: https://datasheets.maximintegrated.com/en/ds/MAX6699.pdf
