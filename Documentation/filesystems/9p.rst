...
For Plan 9 From User Space applications (https://swtch.com/plan9)::
...
https://ericvh.github.com/9p-rfc/

9p client and server implementations are listed on
http://9p.cat-v.org/implementations

A 9p2000.L server is being developed by LLNL and can be found
at https://code.google.com/p/diod/

There are user and developer mailing lists available through the v9fs project
on sourceforge (https://sourceforge.net/projects/v9fs).

News and other information is maintained on a Wiki.
(https://sf.net/apps/mediawiki/v9fs/index.php).
...
ported to Linux/BSD/OSX/etc) check out https://swtch.com/plan9
